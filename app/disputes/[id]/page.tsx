...
export default async function DisputeDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-6">
      ...
      {/*
        Panel posts Accept / Decline to POST /api/disputes/[id]/resolve.
        The helper and route remain a separate seam. Suggested-credit still calls v1.
      */}
      <Card>
        <CardHeader>
          <CardTitle>Resolution</CardTitle>
          <CardDescription>
            Accept or decline posts to{" "}
            <span className="font-mono text-foreground">POST /api/disputes/{dispute.id}/resolve</span>.
            Do not invent a credit above {formatUsd(catalogPrice)}.
          </CardDescription>
        </CardHeader>
