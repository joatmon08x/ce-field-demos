  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col gap-6">
      <PageHeader
        eyebrow="Receivables"
        title="Invoices"
        description={`Seeded ${PRODUCT.industryShort} only. Amounts are Starter $49, Growth $99, or Scale $249 — never a custom figure.`}
      />
      ...
      {invoices.length === 0 ? (
        <EmptyState
          ...
          body="Clear the filter or search. The seed still has Acme North, Riverstone Labs, Cobalt Goods, and the rest of the Packetline book."
