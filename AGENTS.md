...
Shipped suite on a clean tree: **1 failed / 36 passed** for Medly, SaaSly, and Routerly. The `dsp_1043` page shows v1's $400 result; v2 and the stored credit are correctly capped at $249. The planted failure lives in the suggested-credit client, not in a brand profile.
...
| `.cursor/skills/start-application/` | Presenter opener — activate Medly, SaaSly, or Routerly. No UI picker. |
