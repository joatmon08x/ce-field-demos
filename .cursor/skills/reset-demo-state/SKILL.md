...
Goal state: seeded book for the active brand, dev server on 43173, and `npm test` showing exactly **1 failed / 35 passed**. Restore `lib/disputes/suggested-credit-api.ts` if a prior demo switched the client to v2.
