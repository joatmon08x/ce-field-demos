...
| After apply | Write + run the e2e file above. Browser on `dsp_1043`. `npm test` still **1 failed / 32 passed**. `ledgerly-reviewer` then `dispute-verifier` (do not “fix” suggested-credit gates in this slice). |
